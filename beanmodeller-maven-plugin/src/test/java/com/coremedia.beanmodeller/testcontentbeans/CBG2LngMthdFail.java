 ...
 */
@ContentBean
public abstract class CBG2LngMthdFail extends CBGContent {
   ...
   * this. Long names are known to not work in CoreMedia CMS.
   * <p/>
   * Bean Modeller must report both errors.
   *
   * @return random number, not interesting
   */
  public abstract Integer getMethodWithAnOverlyLongMethodNameOfFiftyCharactersPartTwo();
}
