...
public class ContentBeanAnalyzationException extends ContentBeanAnalyzatorInternalException {
  ...
  public static final String INVALID_PRIMITIVE_RETURN_TYPES_MESSAGE = "Property type invalid! Thou shalt not use primitive data types like int or boolean. Allowed types include only ";
